...
//2. transitions need conditions with the state var (isVisible) + .transition() modifier
...
//4. transitions can be tricky, (sometimes needs additional ZStacks, TODO: sometimes whenAnimated does not work)
